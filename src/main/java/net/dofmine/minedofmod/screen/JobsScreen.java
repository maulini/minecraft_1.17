...
public class JobsScreen extends Screen {
    ...
    public void render(PoseStack stack, int mouseX, int mouseY, float partialTicks) {
        ...
        ExtendedHunterJobsEntityPlayer hunter = (ExtendedHunterJobsEntityPlayer) JobsUtil.getAllCapabilitiesForLocalPlayer(Minecraft.getInstance().player).stream().filter(iCapabilityProvider -> iCapabilityProvider instanceof ExtendedHunterJobsEntityPlayer).findFirst().get();
        ExtendedMinerJobsEntityPlayer miner = (ExtendedMinerJobsEntityPlayer) JobsUtil.getAllCapabilitiesForLocalPlayer(Minecraft.getInstance().player).stream().filter(iCapabilityProvider -> iCapabilityProvider instanceof ExtendedMinerJobsEntityPlayer).findFirst().get();
        ExtendedFarmerJobsEntityPlayer farmer = (ExtendedFarmerJobsEntityPlayer) JobsUtil.getAllCapabilitiesForLocalPlayer(Minecraft.getInstance().player).stream().filter(iCapabilityProvider -> iCapabilityProvider instanceof ExtendedFarmerJobsEntityPlayer).findFirst().get();
        ExtendedWizardJobsEntityPlayer wizard = (ExtendedWizardJobsEntityPlayer) JobsUtil.getAllCapabilitiesForLocalPlayer(Minecraft.getInstance().player).stream().filter(iCapabilityProvider -> iCapabilityProvider instanceof ExtendedWizardJobsEntityPlayer).findFirst().get();
        ExtendedLocksmithJobsEntityPlayer locksmith = (ExtendedLocksmithJobsEntityPlayer) JobsUtil.getAllCapabilitiesForLocalPlayer(Minecraft.getInstance().player).stream().filter(iCapabilityProvider -> iCapabilityProvider instanceof ExtendedLocksmithJobsEntityPlayer).findFirst().get();
