...
public class LightningChannelerContainer extends AbstractContainerMenu {
    ...
    public LightningChannelerContainer(int windowId, Level level, BlockPos blockPos, Player player, Inventory playerInventory) {
    ...
    public boolean isLightningStorm() {
        return blockEntity.getLevel().isThundering();
    }
