...
public class ExtendedFarmerJobsEntityPlayer implements ICapabilitySerializable {
    ...
    public static final ExtendedFarmerJobsEntityPlayer get() {
        return (ExtendedFarmerJobsEntityPlayer) attachCapabilitiesEvent.getCapabilities().get(EXT_PROP_NAME);
    }
    ...
    public void sync() {
        PacketFarmerJobs packetJobs = new PacketFarmerJobs(this.xp, this.level);
