...
public class HydrationEntityPlayerServer implements ICapabilitySerializable {

    public final static ResourceLocation EXT_PROP_NAME = new ResourceLocation(MinedofMod.MODS_ID, "hydration_player_server");
    ...
    private static LazyOptional<HydrationEntityPlayerServer> lazyOptional;
    public static Capability<HydrationEntityPlayerServer> HYDRATION = CapabilityManager.get(new CapabilityToken<>() {
        @Override
    ...
    public HydrationEntityPlayerServer(Player player, AttachCapabilitiesEvent<Entity> attachCapabilitiesEvent) {
        this.player = player;
    ...
    public static final void register(Player player, AttachCapabilitiesEvent attachCapabilitiesEvent) {
        HydrationEntityPlayerServer hydration = new HydrationEntityPlayerServer(player, attachCapabilitiesEvent);
        lazyOptional = LazyOptional.of(() -> hydration);
    }

    public static final HydrationEntityPlayerServer get(Player player) {
